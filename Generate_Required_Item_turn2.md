...
FIRST QUESTION and FOLLOW-UP QUESTION: A first question and a follow-up question that have been given to an AI assistant.

## Task Details
Your task is to come up with an evaluation checklist list for the given FOLLOW-UP QUESTION.
This evaluation checklist should be a list of questions that ask whether or not specific criteria relevant to the FOLLOW-UP QUESTION were met by an AI assistant's response.
Criteria covered by your checklist could be explicitly stated in the FOLLOW-UP QUESTION, or be generally sensible criteria for the problem domain.
You should, however, try to be concise and not include unnecessary entries in your checklist.

**Note:** While the FIRST QUESTION provides context, your checklist should focus on evaluating the response to the FOLLOW-UP QUESTION.
...
- **Be comprehensive, but concise**, meaning that all criteria directly relevant to the FOLLOW-UP QUESTION should be represented by a quesion, but only questions that are very clearly relevant should be included.
- **Be precise**, meaning that checklist questions should avoid vague wording and evaluate specific aspects of a response, directly using the phrasing of the FOLLOW-UP QUESTION where appropriate.

You should always analyse the FOLLOW-UP QUESTION before providing an evaluation checklist.
...
Focus on creating evaluation criteria for the follow-up question (second question).
